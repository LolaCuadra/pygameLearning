...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.image = pygame.image.load("images/papi (2).png").convert()
        self.x = 120
        self.y = 120
...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Snake and Harry Styles Game")
        pygame.mixer.init()
    ...
    def play_background_music(self):
        pygame.mixer.music.load("sounds/sushi.mp3")
        pygame.mixer.music.play()
        
    def play_sound(self, sound):
        sound = pygame.mixer.Sound(f"sounds/{sound}.ogg")
